            ...
            <main className="grow">
                ...
                <div className="max-w-4xl mx-auto px-6 py-12">
                    ...
                    <div className="max-w-3xl mx-auto px-6 mb-12">
                        {blog.image && (
                            <div className="relative w-full rounded-2xl overflow-hidden bg-slate-50 border border-slate-100 shadow-sm">
                                <img
                                    src={blog.image}
                                    alt={blog.title}
                                    loading="lazy"
                                    className="block w-full h-auto max-h-125 object-contain mx-auto transition-opacity duration-300"
                                    onLoad={(e) => (e.currentTarget.style.opacity = "1")}
                                />

                                {/* Subtle overlay to keep corners looking sharp */}
                                <div className="absolute inset-0 rounded-2xl pointer-events-none ring-1 ring-inset ring-slate-900/5" />
                            </div>
                        )}
                    </div>
